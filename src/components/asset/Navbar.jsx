...
import quLogo from "./images/qulogo.png";
        ...
        <List>
          {[
            ...
            },
            {
              text: "Our Team",
              link: "/team",
              icon: <GroupIcon sx={{ color: "rgb(129, 41, 114)" }} />,
            },
            {
              text: "Why QU?",
              link: "/why-qu",
              icon: <HelpIcon sx={{ color: "rgb(129, 41, 114)" }} />,
            },
            {
              text: "Placement Statistics",
              link: "/placement-stats",
              icon: (
                <SignalCellularAltIcon sx={{ color: "rgb(129, 41, 114)" }} />
              ),
            },
            {
              text: "Recruitment Process",
              link: "/recruitment",
              icon: <DeveloperBoardIcon sx={{ color: "rgb(129, 41, 114)" }} />,
            },
            {
              text: "Our Recruiters",
              link: "/our-recruiters",
              icon: <BusinessIcon sx={{ color: "rgb(129, 41, 114)" }} />,
            },
            {
              text: "Contact Us",
              link: "/contact",
              icon: <PhoneIcon sx={{ color: "rgb(129, 41, 114)" }} />,
            },
            /* {
            ...
            }, */
            {
              ...
              icon: <LoginIcon sx={{ color: "rgb(129, 41, 114)" }} />,
            },
          ].map((item, index) => (
